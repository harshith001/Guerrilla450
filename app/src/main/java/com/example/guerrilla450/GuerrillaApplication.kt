package com.example.guerrilla450

import android.app.Application
import com.example.guerrilla450.data.DiagnosticsUploader
import com.example.guerrilla450.data.FirebaseFeatures
import com.example.guerrilla450.util.BuildId
import com.example.guerrilla450.util.CrashGuard
import com.example.guerrilla450.util.ExitInfoCollector

class GuerrillaApplication : Application() {
    ...
    private fun rebindNotificationListener() {
        ...
        runCatching {
            if (com.example.guerrilla450.media.MediaInfoProvider.isAccessGranted(this)) {
                android.service.notification.NotificationListenerService.requestRebind(
                    android.content.ComponentName(this, com.example.guerrilla450.media.GuerrillaNotificationListener::class.java)
                )
            }
        }
    }
