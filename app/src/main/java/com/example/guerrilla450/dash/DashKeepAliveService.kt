...
import com.example.guerrilla450.MainActivity
import com.example.guerrilla450.R

/**
 * Foreground service that keeps Guerrilla 450 streaming to the dash while the
...
class DashKeepAliveService : Service() {
    companion object {
        ...
        private const val CHANNEL_ID   = "guerrilla_dash"
        private const val NOTIF_ID     = 4701
        const val ACTION_START = "com.example.guerrilla450.DASH_START"
        const val ACTION_STOP  = "com.example.guerrilla450.DASH_STOP"
    ...
    private fun startForegroundLocks() {
        ...
        try {
            ...
            com.example.guerrilla450.util.Telemetry.recordNonFatal(e, "DashKeepAliveService.startForegroundLocks")
            stopSelf()
        }
    }
    ...
    private fun acquireLocks() {
        ...
        wakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "guerrilla:dash").apply {
        ...
        @Suppress("DEPRECATION")
        wifiLock = wm.createWifiLock(WifiManager.WIFI_MODE_FULL_HIGH_PERF, "guerrilla:dash").apply {
            setReferenceCounted(false)
            acquire()
        }
    }
    ...
    private fun buildNotification(): Notification {
        ...
        return builder
            .setContentTitle("Guerrilla 450 — streaming to dash")
