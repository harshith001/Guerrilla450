package com.example.guerrilla450.dash.nav
 ...
 * so riding can proceed offline. Driving profile suits the Guerrilla 450 fine.
 */
object Router {
    private const val TAG = "Router"
    private const val BASE = "https://router.project-osrm.org/route/v1/driving"
    private const val UA = "Guerrilla450/1.0 (personal motorcycle nav; single user)"
