...
import com.example.guerrilla450.data.SharedLocation
...
import com.example.guerrilla450.util.LocationParser
...
class RouteViewModel(app: Application) : AndroidViewModel(app) {
    ...
    private val _saved = MutableStateFlow<List<com.example.guerrilla450.data.SavedLocation>>(emptyList())
    ...
    fun renameSaved(loc: com.example.guerrilla450.data.SavedLocation, name: String, note: String) =
        viewModelScope.launch { withContext(Dispatchers.IO) { repo.renameSaved(loc, name, note) } }

    fun deleteSaved(loc: com.example.guerrilla450.data.SavedLocation) =
    ...
    fun selectSaved(loc: com.example.guerrilla450.data.SavedLocation) {
