package com.example.guerrilla450.util
 ...
 * any NEW abnormal exits and write them to a diag/crash-*.log, which [com.example.guerrilla450.data.
...
object ExitInfoCollector {
    ...
    private const val PREFS = "guerrilla_exitinfo"
    ...
    private fun writeExit(context: Context, dir: File, info: ApplicationExitInfo) {
        ...
        val text = buildString {
            appendLine("=== Guerrilla 450 process exit (ApplicationExitInfo) ===")
