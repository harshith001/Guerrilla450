 ...
 */
class GuerrillaNotificationListener : NotificationListenerService() {
    ...
    // GuerrillaApplication should have re-bound it).
    override fun onListenerConnected() {
        com.example.guerrilla450.data.RideDiagnostics.log("media", "notification listener CONNECTED")
    }

    override fun onListenerDisconnected() {
        com.example.guerrilla450.data.RideDiagnostics.log("media", "notification listener DISCONNECTED")
    }
    ...
    override fun onNotificationPosted(sbn: StatusBarNotification?) {
        ...
        com.example.guerrilla450.data.RideDiagnostics.log("media",
