 ...
 */
class GuerrillaDb private constructor(context: Context) :
    SQLiteOpenHelper(context.applicationContext, "guerrilla.db", null, 7) {

    companion object {
        @Volatile private var instance: GuerrillaDb? = null
        fun get(context: Context): GuerrillaDb =
            instance ?: synchronized(this) {
                instance ?: GuerrillaDb(context).also { instance = it }
            }
        ...
        /**
         * Canonical maintenance schedule, derived from the RE New Guerrilla 450 owner's manual
