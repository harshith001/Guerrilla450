...
object MaintenanceNotifier {
    ...
    fun checkDocuments(context: Context, docs: List<com.example.guerrilla450.data.VehicleDocument>) {
        val ctx = context.applicationContext
        ...
        fun line(d: com.example.guerrilla450.data.VehicleDocument): String {
